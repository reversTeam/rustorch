...
This project is **pre-1.0** but has shipped through Phase 3. The user-facing
API is documented at [v0.7.2 docs](https://rustorch.dev/docs); the roadmap below
tracks where each milestone stands.

| Phase | Title                                                | Target  | Status        |
|------:|------------------------------------------------------|---------|---------------|
|     0 | Architecture & RFC                                    | 2026-05 | ✅ done       |
|     1 | Fondations CPU + Autograd                             | 2026-08 | ✅ done       |
|     2 | Backend GPU via wgpu (WASM)                           | 2026-11 | ✅ done       |
|   2.5 | Ecosystem & Console backend (CLI, sweeps, RPC, serve) | 2027-08 | ✅ done       |
|     3 | Optimisations avancées (Memory Planning, Flash Attn, Quant, Fusion, AMP, Checkpoint) | 2027-01 | ✅ done       |
|     4 | Backend CUDA natif (opt-in)                           | 2027-04 | 📋 planned    |
|     5 | Distributed Training (DDP, FSDP)                      | 2027-06 | 📋 planned    |
